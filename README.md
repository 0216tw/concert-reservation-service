...
<img src="https://github.com/user-attachments/assets/19dd8670-c074-48f5-9bfc-4445f2dababa" width="1000px" height="500px"/> 

### 테이블 CRUD 빈도 <br> 

테이블 | INSERT  | DELETE  | UPDATE | SELECT | 
| ------ | ------ | -----------| -------|  ---- | 
| CONCERT |  적음 | 적음| 적음 | **매우 많음** | 
| CONCERT_SCHEDULE |  적음 |적음| 적음 | **매우 많음** | 
| CONCERT_SEAT |  보통 | 적음 | 적음 | **매우 많음** | 
| RESERVATION |  o | o | o | o | 
| PAYMENT |  o | o | o | o | 
| USER |  o | o | o | o | 
